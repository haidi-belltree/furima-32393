class PaymentPlace
  ...
  def save
    ...
    payment = Payment.create(item_id: @item.id, user_id: current_user.id)
    Place.create(post_code: post_code, prefecture_id: prefecture_id, city: city, block: block, building: building, phone_number: phone_number, payment_id: payment.id)
  end
end